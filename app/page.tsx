...
import { Search, Star, Shield, Award, Users, ChevronRight, Heart } from "lucide-react"
  ...
  const featuredProducts = [
    {
      ...
      features: ["Real-time monitoring", "AI Analytics", "Cloud connectivity"],
    },
    {
      id: 2,
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-muted-foreground text-pretty max-w-2xl">
                  ...
                  healthcare professionals with cutting-edge technology since 2010.
                </p>
              </div>
      ...
      <section className="py-20 bg-gradient-to-r from-primary to-secondary text-primary-foreground">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-8">
          ...
          <p className="text-lg opacity-90 max-w-2xl mx-auto text-pretty">
            Join hundreds of hospitals worldwide who trust our medical devices for superior patient care.
          </p>
